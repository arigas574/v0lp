  ...
  return (
    <footer className="border-t border-border bg-card">
      <div className="mx-auto max-w-6xl px-6 py-0">
        {/* Topo: Logo, Redes Sociais, Links */}
        <div className="grid grid-cols-3 items-center gap-4">
          {/* Logo Calendro - Esquerda */}
          ...
          <div className="flex items-center justify-center gap-2">
            {[
              ...
              <a
                ...
                aria-label={label}
                className="flex size-9 items-center justify-center rounded-lg border border-border text-muted-foreground transition-colors hover:border-zinc-500 hover:text-foreground"
              >
          ...
          <div className="flex items-center justify-end gap-6">
            <a href="/privacidade" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
        ...
        <div className="mt-4 flex flex-col items-center gap-1">
          ...
          {/* Copyright */}
          <p className="text-xs text-zinc-600 mt-2 mb-5">
